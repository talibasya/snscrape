...
class TwitterProfileScraper(TwitterUserScraper):
	...
	def get_items(self):
		...
		gotPinned = False
		for obj in self._iter_api_data('https://twitter.com/i/api/graphql/zQxfEr5IFxQ2QZ-XMJlKew/UserTweetsAndReplies', _TwitterAPIType.GRAPHQL, variables, paginationVariables):
